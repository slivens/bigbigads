...
Route::get('/affialites/{track}/payments', 'UserController@getPaymentsByAffiliateTrack');
...
*/
Route::post(
    '/trackState', function (Request $request) {
    }
)->middleware('track');
