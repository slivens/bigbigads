...
<!-- Global site tag (gtag.js) - Google AdWords: 828108332 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-828108332"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-828108332');
</script>
<!-- Facebook Pixel Code -->
<script>
