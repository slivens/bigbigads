...
<section class="plan-banner">
    <div class="container">
         ...
         <div class="plan-card-wrapper text-center">
            ...
            <div class="plan-card plan-card-orange" card-name="standard-card">
                <div class="card-front" turn-back="standard-card" onclick="window.uetq = window.uetq || []; window.uetq.push({'ec':'conversion', 'ea':'click_signup_standard','el':'click','ev':12 });ga('send', 'event', 'conversion', 'click', 'signup_standard');">
