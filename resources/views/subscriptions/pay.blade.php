...
<head>
    ...
    <link href="./dist/pay.css?v=1" rel="stylesheet">
    <script>
...
<body>
    <div id="app">
                ...
                <div class="pay-content">
                    <div class="alert pay-alert-gray pay-overview">
                        <div class="row overview-describe">
                            <div class="col-sm-7  descr-left-text pay-font-14">
                            <span class="paypage-title overview-title">Order Overview:</span>
                                <p class="pay-font-14" for="price" v-bind:extra='initAmount({{$plan->amount}})'>BIGBIGADS(<span class="">{{$plan->display_name}}</span>) - Get Inspired by most successful Facebook ad campaign of your competitors.Create your high-performance ads.</p>
                                 
                            </div>
                            <div class="col-sm-5 descr-right-text">
                                <p class="overview-cost pay-font-18">Today's Payment: 
                                    <span class="" v-cloak >$@{{ amount }}.00</span>
                                </p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-7 pay-font-14">
                            ...
                            <div class="col-sm-5">
                                <div class="pay-font-14 text-right overview-notice">
                    ...
                    <form action="{{url('/pay')}}" method="post" id="checkout">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div v-bind:class="{'form-group':true, 'pay-email-div':true, 'has-error':emailErr}">
                                         <input type="email" class="form-control" placeholder="Email" name="Email" v-model="email" v-on:keyup="emailEnter" v-on:blur="emailEnter">
                                         <label v-bind:class="{'control-label':true, 'email-remain':true, 'pay-font-14':true, 'show':emailErr}">@{{emailMessage}}</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 pay-font-14 email-text">
                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-sm-6 coupon-form ">
                                     <div class="navbar-form pay-font-16">
                                ...
                                <div class="col-sm-6 coupon-text pay-font-14">
                        ...
                        <div class="alert pay-payment">
                            ...
                            <div class="row payment-div">
                                <div class="col-sm-6 pay-font-14">
                                ...
                                <div class="col-sm-6 payment-right-div">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                          <input type="checkbox"> <span class="pay-font-14">Check the box to use Credit Card through PayPal</span> 
                                        </label>
                                    </div> -->
                                    @if (Auth::guest())
                                    ...
                                    @else
                                    <div class="payment-btn text-center">
                                        <input type="button" border="0" alt="PayPal - The safer, easier way to pay online!" class="btn paypal-btn" value="" v-on:click="toPay" >
                                    </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row pay-creditcard">
                                ...
                                <div class="col-sm-6 creditcard-btn clearfix">
                                    <div class="text-center">
                                        <button class="btn pay-font-22" disabled="disabled"><i class="glyphicon glyphicon-credit-card credit-icon pay-font-24"></i>Credit Card</button>
                                    </div>
                                ...
                                <div class="creditcard-disable text-center pay-font-22" disabled="disabled" > Coming Soon:Check out with Credit Card</div>
                            </div>
                            <hr>
                            <h4>Terms of Sales:</h4>
                            <ul class="pay-font-14">
                    ...
                    <div class="row pay-footer pay-font-14">
        ...
        <div v-bind:class="{'pay-loading':true, 'hidden':showLoading}">
            ...
            <p class="loading-text pay-font-18">loading...</p>
        </div>
    </div>
</body>
</html>
...
<script type="text/javascript" src="dist/pay.js?v=1"></script>
