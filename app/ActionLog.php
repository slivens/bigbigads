...
class ActionLog extends Model
{
    ...
    const ACTION_SEARCH_TIMES_PERDAY_RESTRICT = "SEARCH_TIMES_PERDAY_RESTRICT";
    const ACTION_SEARCH_RESTRICT_PERDAY_ADSER = "SEARCH_RESTRICT_PERDAY_ADSER";
    const ACTION_AD_ANALYSIS_TIMES_PERDAY_RESTRICT = "AD_ANALYSIS_TIMES_PERDAY_RESTRICT";
    const ACTION_ADSER_SEARCH_WITHOUT_KEY_RESTRICT = "ADSER_SEARCH_WITHOUT_KEY_RESTRICT";
    const ACTION_ADSER_SEARCH_KEY_RESTRICT = "ADSER_SEARCH_KEY_RESTRICT";
    const ACTION_ADSER_SEARCH_TIMES_PERDAY_RESTRICT = "ADSER_SEARCH_TIMES_PERDAY_RESTRICT"; // 每日请求查看特定广告主
    const ACTION_ADSER_ANALYSIS_PERDAY_RESTRICT = 'ADSER_ANALYSIS_PERDAY_RESTRICT';         // 每日请求查看广告主分析次数
     ...
     * 广告主搜索页行为记录
     */
    const ACTION_ADSER_WITHOUT_KEY_RESTRICT       = 'ADSER_WITHOUT_KEY_RESTRICT';
    const ACTION_ADSER_KEY_RESTRICT               = 'ADSER_KEY_RESTRICT';
    const ACTION_ADSER_WITHOUT_KEY_TOTAL_PERDAY   = 'ADSER_WITHOUT_KEY_TOTAL_PERDAY';
    const ACTION_ADSER_KEY_TOTAL_PERDAY           = 'ADSER_KEY_TOTAL_PERDAY';
    const ACTION_ADSER_LIMIT_KEYS_PERDAY          = 'ADSER_LIMIT_KEYS_PERDAY';
    const ACTION_ADSER_LIMIT_WITHOUT_KEYS_PERDAY  = 'ADSER_LIMIT_WITHOUT_KEYS_PERDAY';
