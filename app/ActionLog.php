...
class ActionLog extends Model
{
     ...
     * 移动端行为记录
     */
     const ACTION_MOBILE_ADSER_INIT = "MOBILE_ADSER_INIT";
     const ACTION_MOBILE_ADSER_SEARCH = "MOBILE_ADSER_SEARCH";
     const ACTION_MOBILE_ADSER_LIMIT = "MOBILE_ADSER_LIMIT";
     const ACTION_MOBILE_ADSER_ANALYSIS = "MOBILE_ADSER_ANALYSIS";
     const ACTION_MOBILE_ADSER_ADS_ANALYSIS = "MOBILE_ADSER_ADS_ANALYSIS";
     const ACTION_MOBILE_ADSER_LIKE_TOPADS = "MOBILE_ADSER_LIKE_TOPADS";
     const ACTION_MOBILE_ADSER_IMPRESSIOM_TOPADS = "MOBILE_ADSER_IMPRESSIOM_TOPADS";
