...
class BigbigadsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $searchPermission = ['search_times_perday'=>[true, true, true, true, true, true], 'result_per_search'=>[true, true, true, true, true, true], 'search_filter'=>[false, true, true, true, true, true], 'search_sortby'=>[false, false, true, true, false, false], 'advanced_search'=>[false, false, true, true, false, false], 'save_search' => [false, true, true, true, true, true], 'keyword_times_perday' => [true, true, true, true, true, true],
            'advertiser_search' => [true, true, true, true, true, true], 'dest_site_search' => [true, true, true, true, true, true], 'domain_search' => [true, true, true, true, true, true], 'content_search' => [true, true, true, true, true, true], 'audience_search' => [true, true, true, true, true, true], 
            'date_filter' => [true, true, true, true, true, true], 'format_filter' => [true, true, true, true, true, true], 'call_action_filter' => [false, true, true, true, true, true], 'duration_filter' => [true, true, true, true, true, true], 'see_times_filter' => [true, true, true, true, true, true], 'lang_filter' => [false, true, true, true, true, true], 'engagement_filter' => [false, false, true, true, false, false], 
            ...
            'timeline_filter' => [true, true, true, true, true, true], 'phone_filter' => [true, true, true, true, true, true], 'rightcolumn_filter' => [true, true, true, true, true, true], 'advance_likes_filter' => [true, true, true, true, true, true], 'advance_shares_filter' => [true, true, true, true, true, true], 'advance_comments_filter' => [true, true, true, true, true, true], 'advance_video_views_filter' => [true, true, true, true, true, true], 'advance_engagement_filter' => [true, true, true, true, true, true],
            'search_init_perday' => [true, true, true, true, true, true], 'search_limit_perday' => [true, true, true, true, true, true], 'search_where_perday' => [true, true, true, true, true, true], 'specific_adser_init_perday' => [true, true, true, true, true, true], 'specific_adser_limit_perday' => [true, true, true, true, true, true], 'specific_adser_where_perday' => [true, true, true, true, true, true], 'app_filter' => [false, false, false, true, false, false], 'search_total_times' => [true, true, true, true, true, true]];
        ...
        $searchPolicy = ['search_times_perday' => [Policy::DAY, 100, 1000, 3000, 5000, 1000, 1000], 'result_per_search' => [Policy::VALUE, 100, 300, 2000, 5000, 300, 300], 'keyword_times_perday' => [Policy::DAY, 1000, 1000, 1000, 1000, 1000, 1000], 'search_init_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000], 'search_limit_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000], 'search_where_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000],
                         'specific_adser_init_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000], 'specific_adser_limit_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000], 'specific_adser_where_perday' => [Policy::DAY, 10000, 10000, 10000, 10000, 10000, 10000], 'search_total_times' => [Policy::PERMANENT, 0, 0, 0, 0, 0, 0]];
